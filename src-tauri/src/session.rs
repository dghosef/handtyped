...
mod tests {
    ...
    fn test_key_event_serializes() {
        let e = KeyEvent { t: 1_000_000, kind: "down".into(), key: 4, flags: 0, suspicious: false };
    ...
    fn test_key_event_suspicious_serializes() {
        let e = KeyEvent { t: 1_000_000, kind: "down".into(), key: 4, flags: 0, suspicious: true };
        let json = serde_json::to_string(&e).unwrap();
    ...
    fn test_session_keystroke_count() {
        ...
        s.append_key(KeyEvent { t: 1, kind: "down".into(), key: 4, flags: 0, suspicious: false });
        s.append_key(KeyEvent { t: 2, kind: "up".into(), key: 4, flags: 0, suspicious: false });
    ...
    fn test_log_chain_advances() {
        ...
        assert_ne!(chain_before, chain_after, "chain must advance after each entry");
    }
