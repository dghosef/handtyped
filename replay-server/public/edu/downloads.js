export const STUDENT_RELEASE_ID = '0.1.1-20260511.2255-windows-touchpad-shell-signed'
...
export const STUDENT_DOWNLOADS = Object.freeze({
  macosAppleSilicon: Object.freeze({
    ...
    label: 'Download for Mac with Apple chip (M1 or newer, late 2020+)',
    compactLabel: 'Student app (Mac M1 or newer)',
    detectedLabel: 'Mac with Apple chip',
  }),
  macosIntel: Object.freeze({
    ...
    label: 'Download for Intel Mac (2019 or earlier, or some 2020 models)',
