...
describe('teacher navigation', () => {
  ...
  it('exposes the notarized student app download on the edu landing page', () => {
    ...
    expect(eduLandingHtml).toContain('Download Apple Silicon')
    ...
    expect(eduLandingHtml).toContain('Download Intel Mac')
    ...
    expect(eduLandingHtml).toContain('Download Windows x86-64')
